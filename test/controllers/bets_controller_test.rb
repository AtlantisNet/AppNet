...
class BetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post bets_url, params: { bet: { pagina_id: @bet.pagina_id, time1: @bet.time1, time2: @bet.time2, user_id: @bet.user_id, valor: @bet.valor } }
    end
  ...
  test "should update bet" do
    patch bet_url(@bet), params: { bet: { pagina_id: @bet.pagina_id, time1: @bet.time1, time2: @bet.time2, user_id: @bet.user_id, valor: @bet.valor } }
